...
from sparamiko import *


class TestSimpleParamiko(unittest.TestCase):
    """
...
class TestSimpleParamikoCreation(TestSimpleParamiko):
...
class TestSimpleParamikoNewClient(TestSimpleParamiko):
...
class TestSimpleParamikoIsConnected(TestSimpleParamiko):
...
class TestSimpleParamikoTerminate(TestSimpleParamiko):
...
class TestSimpleParamikoConnect(TestSimpleParamiko):
...
class TestSimpleParamikoGetConsole(TestSimpleParamiko):
    ...
    def test_get_console_success(self):
        ...
        result = self.ssh.get_console(retry_timeout=0.1)
    ...
    def test_get_console_failure(self):
        ...
        exception = None
        try:
            self.ssh.get_console(retry_timeout=0.1, attempts=2)
...
class TestSimpleParamikoRunCommand(TestSimpleParamiko):
    def test_run_command_success_sudo(self):
        ...
        self.ssh.get_console = get_console_mock
...
class TestSimpleParamikoRunCommandIgnoreFailure(TestSimpleParamiko):
